...
Run the test script to see the verification in action:

```bash
# Make sure your services are running first
cd ai_minds_project
python test_relevance_verification.py
```

This will run tests with and without verification and show you the difference.
