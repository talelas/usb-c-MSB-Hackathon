...
QDRANT_COLLECTION = os.getenv("QDRANT_COLLECTION", "ai_minds_embeddings")

# ── PostgreSQL ───────────────────────────────────────────────
POSTGRES_HOST = os.getenv("POSTGRES_HOST", "localhost")
POSTGRES_PORT = int(os.getenv("POSTGRES_PORT", "5432"))
POSTGRES_USER = os.getenv("POSTGRES_USER", "aiminds")
POSTGRES_PASS = os.getenv("POSTGRES_PASSWORD", "aiminds")
POSTGRES_DB   = os.getenv("POSTGRES_DB", "aiminds")
